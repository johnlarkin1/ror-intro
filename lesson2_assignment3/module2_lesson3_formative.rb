class Person
  ...
  def initialize(x,y)#should take 2 parameters for first_name and last_name
    ...
    self.first_name = x
    self.last_name = y
    @@people.push self # see lesson from 2.1.b Arrays
  end
  ...
  def self.search(last_name)
    ...
    @@people.select {|person| person.last_name == last_name} # see lesson from 2.1.b Arrays
  end
  ...
  def to_s
    ...
    "#{self.first_name} #{self.last_name}" # see lesson from 2.2.c Modules 
  end
end
